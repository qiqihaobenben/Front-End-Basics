...
其核心模型结构最早来自于 2017 年的论文，而“创意引导”的方法则来源于 2020 年的论文，其他技术更是离不开所有 AI 科研人员的长期积累。
...
- 跟「办公软件」结合，辅助文字处理、数据分析和演示制作，比如，office 的下一步动作。
