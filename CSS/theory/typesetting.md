<!--
 * @Author: chenfangxu
 * @Date: 2020-11-09 16:04:33
 * @Description: CSS 排版
 * @LastEditors: chenfangxu
 * @LastEditTime: 2021-03-22 23:49:35
 * @FilePath: /front/CSS/theory/typesetting.md
-->
...
在一个元素嵌套着另一个元素的情况下，假设没有内边距或边框来分隔外边距（要在父元素上设置），他们的内边距也会折叠。
